...
return view.extend({
  ...
  render: function(cfg) {
    ...
    var rowsApp = [
      ...
      mkRow('Publish mode (0/1)', 'publish_mode', cfg.publish_mode || '0', 'Legacy-Schalter (ohne Runtime-Fanout, nur Kompatibilität)', 'number'),
      mkRow('Publish snapshot (0/1)', 'publish_snapshot', cfg.publish_snapshot || '0', 'Legacy-Schalter (ohne Runtime-Fanout, nur Kompatibilität)', 'number'),
